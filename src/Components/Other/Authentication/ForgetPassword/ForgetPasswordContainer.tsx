...
import { AlreadyHaveAnAccount, AuthSignIn, CreateYourPassword, DoneButton, EnterOTP, EnterYourMobileNumber, Href, IfDontReceiveOtpString, ImagePath, NewPassword, RememberPassword, Resend, ResetYourPassword, RetypePassword, Send } from "@/Constant/constant";
              ...
              <div className="login-main">
                <Form className="theme-form" onSubmit={(e)=>e.preventDefault()}>
                  ...
                  <FormGroup>
                    ...
                    <Row>
                      <Col sm="3" className="col-4"><Input type="tel" defaultValue="+ 91" /></Col>
