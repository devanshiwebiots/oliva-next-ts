...
import { AlreadyHaveAnAccount, AuthSignIn, EnterYourPassword, ImagePath, RememberPassword, Unlock } from "@/Constant/constant";
        ...
        <Row>
          <Col sm="12">
            <div className="login-card login-dark">
              <div>
                <div><Link className="logo" href="/dashboard/default">
                  <img className="img-fluid for-dark" src={`${ImagePath}/logo/logo.png`} alt="looginpage"/>
                  <img className="img-fluid for-light" src={`${ImagePath}/logo/logo-1.png`} alt="looginpage"/></Link></div>
