import { ConfirmPasswordWizard, ConfirmPasswordWizardPlaceholder, EmailAddressWizardPlaceholder, EnterYourEmailPasswordToLoginWizard, PasswordWizard, PasswordWizardPlaceholder, SignUpToAccount } from "@/Constant/constant";
