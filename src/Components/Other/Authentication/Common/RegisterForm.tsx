...
import { AgreeWithSignUp, AlreadyHaveAnAccount, AuthSignIn, CreateAccount, CreateYourAccount, EmailAddressSignUp, EnterYourPersonalDetailsToCreateAccount, Href, ImagePath, OrSignUpWith, PasswordSignUp, PrivacyPolicy, YourNameSignUp } from "@/Constant/constant";
