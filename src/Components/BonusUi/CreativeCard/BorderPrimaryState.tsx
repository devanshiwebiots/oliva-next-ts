import { BryanOwens, GloriaAcheson, Href, ImagePath, PrimaryBorderState, TeresaMoselles } from "@/Constant/constant";
import { BorderPrimaryData } from "@/Data/BonusUi/CreativeCard/CreativeCardData";
