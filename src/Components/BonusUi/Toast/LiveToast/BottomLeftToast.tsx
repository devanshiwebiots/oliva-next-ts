import { BottomLeftToasts, ImagePath, ImNotSure, RemoveMyAccount, YourAccountWillBePermanentlyDeleted } from "@/Constant/constant";
      ...
      <div className="toast-container position-fixed start-0 bottom-0 p-3 toast-index toast-rtl">
        <Toast fade isOpen={open}>
          <div className="toast-header toast-img">
            <Image priority width={30} height={30} className="rounded me-2" src={`${ImagePath}/dashboard/profile.png`} alt="profile" unoptimized/>
