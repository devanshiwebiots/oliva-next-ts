import { ActiveTasksData, MonthlyDropdownList } from "@/Data/General/Dashboard/DashboardData";
...
export const ActiveTasksCard: React.FC<TotalEarningCardProp> = ({ colClass }) => {
  ...
  return (
    <div className={colClass}>
      <Card>
        <DropdownWithHeader headerClass="card-no-border pb-0" heading={ActiveTasksTitle} dropDownList={MonthlyDropdownList} dropDownClass="icon-dropdown" dropDownIcon={true} />
