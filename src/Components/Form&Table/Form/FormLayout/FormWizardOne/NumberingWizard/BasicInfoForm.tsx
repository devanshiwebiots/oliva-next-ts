...
import { AgreeToTermsAndConditions, OlivaMail, ConfirmPassword, Email, EnterConfirmPassword, EnterPassword, EnterYourName, FirstName, Password } from "@/Constant/constant";
      ...
      <Row>
        <Col sm="6">
          <FormGroup>
            ...
            <Input onChange={getUserData} value={email} name="email" type="email" placeholder={OlivaMail} />
          </FormGroup>
        </Col>
        <Col sm="6">
          <FormGroup>
