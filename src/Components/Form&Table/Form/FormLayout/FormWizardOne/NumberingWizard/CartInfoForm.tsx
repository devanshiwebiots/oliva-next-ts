...
import { AboveInformationCorrect, AdharaPlaceholder, CVVNumber, CardNumber, Expiration, ExpiryPlaceholder, PlaceHolderName, PlaceholderName, UploadDocumentation } from "@/Constant/constant";
      ...
      <Row>
        ...
        <Col xxl="4" sm="6">
          <FormGroup>
            ...
            <Input name="cardNumber" value={cardNumber} onChange={getUserData} type="text" placeholder={AdharaPlaceholder} />
          </FormGroup>
        </Col>
        <Col xxl="4" sm="6">
          <FormGroup>
