...
import { AgreeToTermsAndConditions, OlivaMail, ContactNumber, Email, EnterFirstName, EnterLastName, EnterNumber, FirstName, LastName, Next, State, ZipCode } from "@/Constant/constant";
      ...
      <Row>
        ...
        <Col xxl="4" sm="6">
          <FormGroup>
            ...
            <Input name="email" type="email" placeholder={OlivaMail} value={email} onChange={getUserData} />
          </FormGroup>
        </Col>
        <Col xxl="5" sm="6">
          <FormGroup>
