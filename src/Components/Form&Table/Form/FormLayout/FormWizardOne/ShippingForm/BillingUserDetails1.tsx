...
import { Address, OlivaMail, ContactNumber, Email, EnterFirstName, EnterLastName, EnterNumber, FirstName, LastName } from "@/Constant/constant";
  ...
  return (
    <>
      ...
      <Col sm="6">
        ...
        <Input value={email} onChange={getUserData} name="email" type="email" placeholder={OlivaMail} />
      </Col>
      <Col sm="12">
        <FormGroup>
