import { AboveInformationCorrect, CVVNumber, CardHolder, CardHolderPlaceholder, CardNumber, CardNumberPlaceholder, Expiration, ExpiryPlaceholder, UploadDocumentation } from "@/Constant/constant";
