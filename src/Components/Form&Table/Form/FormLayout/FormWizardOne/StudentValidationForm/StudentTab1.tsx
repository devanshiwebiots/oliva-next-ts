...
import { OlivaMail, ConfirmPassword, Email, EnterConfirmPassword, EnterPassword, EnterYourName, Name, Password } from "@/Constant/constant";
  ...
  return (
    <Row className="g-3">
      ...
      <Col sm="6">
        ...
        <Input name="email" onChange={getUserData} value={email} type="email" placeholder={OlivaMail} />
      </Col>
      <Col xs="12">
