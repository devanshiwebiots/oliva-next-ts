...
import { AddProfile, ImagePath, PortfolioURL, ProjectDescription } from "@/Constant/constant";
  ...
  return (
      <Row className="g-3 avatar-upload">
        ...
        <Col xs="12">
          ...
          <Input value={portfolioURL} onChange={getUserData} name="portfolioURL" type="url" placeholder="https://Oliva" />
        </Col>
        <Col xs="12">
