...
import { AgreeToTermsAndConditions, OlivaMail, ContactNumber, Continue, Email, EnterFirstName, EnterLastName, EnterNumber, FirstName, LastName, State, ZipCode } from "@/Constant/constant";
    ...
    <Form onSubmit={(event) => event.preventDefault()} className="needs-validation" noValidate>
      <Row className="g-3">
        ...
        <Col xl="4" xs="12">
          ...
          <Input id="customEmail" type="email" placeholder={OlivaMail} value={email} name="email" onChange={getUserData}/>
        </Col>
        <Col xl="5" sm="4">
