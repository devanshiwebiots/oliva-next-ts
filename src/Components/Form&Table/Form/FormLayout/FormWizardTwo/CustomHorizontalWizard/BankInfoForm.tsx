...
import { AadhaarNumber, AdharaPlaceholder, Continue, PAN, PanPlaceholder, Previous } from "@/Constant/constant";
    ...
    <Form onSubmit={(event) => event.preventDefault()} className="needs-validation" noValidate>
      <Row className="g-3">
        <Col sm="6" className="bank-search">
          ...
          <Input value={aadhaarNumber} name="aadhaarNumber" onChange={getUserData} type="search" placeholder={AdharaPlaceholder} />
        </Col>
        <Col sm="6" className="bank-search">
