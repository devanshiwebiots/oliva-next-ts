...
import { AdharaPlaceholder, AgreeToTermsAndConditions, CardHolder, CardNumber, Continue, Previous } from "@/Constant/constant";
    ...
    <Form onSubmit={(event) => event.preventDefault()} className="needs-validation" noValidate>
      <Row className="g-3">
        ...
        <Col md="6">
          ...
          <Input value={cardNumber} name="cardNumber" onChange={getUserData} type="text" placeholder={AdharaPlaceholder} />
        </Col>
