...
import { MoviesList, RemoteTypeHeadData } from "@/Data/Form&Table/Form/FormData";

const RemoteTypeAhead = () => {
  return (
    <Col sm="12" md="6">
      <Card>
        <CommonCardHeader title={RemoteTypeAheadHeading} subTitle={RemoteTypeHeadData} headClass="pb-0" />
        <CardBody>
          <div id="remote">
