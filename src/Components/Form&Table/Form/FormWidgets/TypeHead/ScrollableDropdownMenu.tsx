...
import { CountryDataList, ScrollableDropdownData } from "@/Data/Form&Table/Form/FormData";

const ScrollableDropdownMenu = () => {
  return (
    <Col sm="12" md="6">
      <Card>
        <CommonCardHeader title={ScrollableDropDownMenu} subTitle={ScrollableDropdownData} headClass="pb-0" />
        <CardBody>
