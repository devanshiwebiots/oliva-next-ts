...
import { ButtonsWithPrefixAndPostFixTitle, PostText, PreText } from "@/Constant/constant";
...
const ButtonsWithPrefixAndPostfix = () => {
  ...
  return (
    <Col xl="6">
      <Card>
        <CommonCardHeader title={ButtonsWithPrefixAndPostFixTitle} subTitle={TouchSpinData} headClass="pb-0" />
