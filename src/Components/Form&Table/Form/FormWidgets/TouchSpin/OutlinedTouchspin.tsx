...
import { DefaultTouchSpinData, TouchSpinData } from "@/Data/Form&Table/Form/FormData";
...
const OutlinedTouchspin = () => {
  ...
  return (
    <Col xl="6">
      <Card>
        <CommonCardHeader title={OutlinedTouchspinTitle}  subTitle={TouchSpinData} headClass="pb-0" />
