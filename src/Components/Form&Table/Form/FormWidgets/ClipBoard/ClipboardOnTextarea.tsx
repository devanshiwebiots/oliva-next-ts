...
import { ClipboardOnTextAreas, Copy, Cut, CutCopyFromTextarea } from "@/Constant/constant";
        ...
        <CardBody>
          <div className="clipboaard-container">
            ...
            <div className="mt-3 text-end">
                <Button className="btn-clipboard me-2" color="warning" onClick={handleCopy}><i className="fa fa-copy"></i> {Copy}</Button>
                <Button className="btn-clipboard-cut" color="success" onClick={handleCut}><i className="fa fa-cut"></i> {Cut}</Button>
            </div>
          </div>
        </CardBody>
      </Card>
