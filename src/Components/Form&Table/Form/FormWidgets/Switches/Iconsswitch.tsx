...
import { IconSwitchData, IconSwitchDataList } from "@/Data/Form&Table/Form/FormData";

const IconsSwitch = () => {
  return (
    <Col xl="4" sm="6">
      <Card className="height-equal">
        <CommonCardHeader title={IconsSwitches} subTitle={IconSwitchData} headClass="pb-0" />
