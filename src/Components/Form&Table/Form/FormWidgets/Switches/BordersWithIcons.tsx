...
import { BorderIconSwitchData, BorderIconSwitchDataList } from "@/Data/Form&Table/Form/FormData";

const BordersWithIcons = () => {
  return (
    <Col xl="4">
      <Card className="height-equal">
        <CommonCardHeader title={BordersWithIcon} subTitle={BorderIconSwitchData} headClass="pb-0" />
