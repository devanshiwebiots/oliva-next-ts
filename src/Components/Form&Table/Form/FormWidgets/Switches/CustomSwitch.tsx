...
import { CustomSwitchData, CustomSwitchDataList } from "@/Data/Form&Table/Form/FormData";

const CustomSwitch = () => {
  return (
    <Col md="12">
      <Card>
        <CommonCardHeader title={CustomSwitches} subTitle={CustomSwitchData} headClass="pb-0" />
        <CardBody>
          <Row className="g-3">
