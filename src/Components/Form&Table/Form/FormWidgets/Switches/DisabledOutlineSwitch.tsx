...
import { DisableOutlineSwitchData, DisableOutlineSwitchDataList } from "@/Data/Form&Table/Form/FormData";

const DisabledOutlineSwitch = () => {
  return (
    <Col md="6">
      <Card>
        <CommonCardHeader title={DisabledOutlineSwitches} subTitle={DisableOutlineSwitchData} headClass="pb-0" />
