...
import { TooltipInitialValue, TooltipValidationSchema, TooltipValidations } from "@/Data/Form&Table/Form/FormData";
...
const TooltipFormValidation = () => {
  ...
  return (
    <Col sm="12">
      <Card>
        <CommonCardHeader title={FormValidationTooltip} subTitle={TooltipValidations} headClass="pb-0" />
        <CardBody>
