...
import { City, CityFeedback, FirstName, LastName, LooksGood, MarkFirstNamePlaceholder, State, StateChoose, StateFeedback, SubmitButton, Username, UsernameFeedback, Zip, ZipFeedback, OttoLastNamePlaceholder } from "@/Constant/constant";
