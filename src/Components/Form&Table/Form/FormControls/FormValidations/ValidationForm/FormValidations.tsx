...
import { AgreeCondition, ChooseFiles, City, Description, FirstName, LooksGood, MarkFirstNamePlaceholder, PasswordValidation, PayMethodTitle, SelectThemeTitle, State, SubmitButton, TextAreaPlaceHolder, VISA, Zip } from "@/Constant/constant";
import { Button, Col, FormFeedback, FormGroup, Label, Row } from "reactstrap";
import { FormValidationsProp } from "@/Types/FormType";
import { ValidationFormStateList, ValidationRadioList, ValidationStateList } from "@/Data/Form&Table/Form/FormData";
