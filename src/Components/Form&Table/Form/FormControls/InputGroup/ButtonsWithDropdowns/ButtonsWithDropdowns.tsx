...
import { ButtonsWithDropdown, ButtonsWithDropdownTitle } from "@/Constant/constant";
import ButtonDropdownList from "./Common/ButtonDropdownList";
import { ButtonWithDropForth, ButtonWithDropOne, ButtonWithDropThird, ButtonWithDropTwo, ButtonWithDropdownData } from "@/Data/Form&Table/Form/FormData";
...
const ButtonsWithDropdowns = () => {
  return (
    ...
    <Card className="height-equal">
      <CommonCardHeader title={ButtonsWithDropdown} subTitle={ButtonWithDropdownData} headClass="pb-0" />
