...
import { SegmentedButton, SegmentedButtonInfo, SegmentedButtonSecondary } from "@/Constant/constant";
import { SegmentButtonData, SegmentDataOne, SegmentDataTwo } from "@/Data/Form&Table/Form/FormData";
  ...
  return (
    <Col md="6">
      <Card className="height-equal">
        <CommonCardHeader title={SegmentedButton} subTitle={SegmentButtonData} headClass="pb-0" />
