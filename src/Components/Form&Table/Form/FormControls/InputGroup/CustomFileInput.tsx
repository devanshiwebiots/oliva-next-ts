...
import {  CustomFileInputs, CustomFileInputsSubmit, CustomFileInputsUpload, CustomFileInputsVerify,} from "@/Constant/constant";
  ...
  return (
    <Col xl="6">
      <Card className="height-equal">
        <CommonCardHeader title={CustomFileInputs} subTitle={CustomeFileInputData} headClass="pb-0" />
