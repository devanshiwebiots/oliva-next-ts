...
import { CustomForm, CustomFormSubmit, FavoriteChocolatesTitle, FavoriteColorsTitle, FavoriteThemeTitle, OptionsFormGroup, PixelstrapThemeTitle } from "@/Constant/constant";
import CustomFormSelect from "./Common/CustomFormSelect";
import { ChocolateData, ColorData, CustomFormData, FavoriteThemeData, PixelData } from "@/Data/Form&Table/Form/FormData";
...
const CustomForms = () => {
  return (
    <Col md="6">
    <Card>
      <CommonCardHeader title={CustomForm} subTitle={CustomFormData} headClass="pb-0" />
