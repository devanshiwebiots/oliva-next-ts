...
import { SizingFormData, SizingFormDataList } from "@/Data/Form&Table/Form/FormData";
...
const SelectSizing = () => {
  return (
    <Col md="6">
      <Card>
        <CommonCardHeader title={SelectSizings} subTitle={SizingFormData} headClass="pb-0" />
        <CardBody>
