...
import { FloatingInputGroup, FloatingInputGroupFeed } from "@/Constant/constant";
import { CommonFloatingFormGroupProp } from "@/Types/FormType";

const CommonFloatingFormGroup :React.FC<CommonFloatingFormGroupProp>= ({ floatingLabel,inputClass,floatClass,invalid,required }) => {
  return (
    <Row className="mb-3">
