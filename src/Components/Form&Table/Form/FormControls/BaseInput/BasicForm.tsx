...
import { CheckMeOut, EmailLabel, EmailPlaceHolder, FormBasic, PasswordLabel, PasswordPlaceholder, SignInButton } from "@/Constant/constant";
...
const BasicForm = () => {
  return (
    <Col md="6">
      <Card>
        <CommonCardHeader title={FormBasic} subTitle={BasicFormData} headClass="pb-0" />
        <CardBody>
