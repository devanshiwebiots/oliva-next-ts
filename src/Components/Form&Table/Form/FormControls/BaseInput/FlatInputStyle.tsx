...
import { FlatInputStyles, PleaseDoComments, SelectYourFavoriteRomanNumber, SelectYourMultiplePaintings } from "@/Constant/constant";
import { FlatInputStyleList, FlatInputTypeData, FlateStyleDataList } from "@/Data/Form&Table/Form/FormData";
...
const FlatInputStyle = () => {
  return (
    <Col md="6">
      <Card>
        <CommonCardHeader title={FlatInputStyles} subTitle={FlatInputTypeData} headClass="pb-0" />
