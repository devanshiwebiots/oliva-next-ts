    ...
    <CardBody className="custom-input">
      <Row>
        <Col>
          ...
          <CommonFormGroup inputType="color" colSm="2" label={BasicColorPicker} labelClass="pt-0" inputClass="form-control-color" defaultValue="#008dab" />
