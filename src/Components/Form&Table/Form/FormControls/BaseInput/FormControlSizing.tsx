...
import { FormControlSizings, FormControlSizingsPlaceholder } from "@/Constant/constant";
...
const FormControlSizing = () => {
  return (
    <Col md="6">
      <Card>
        <CommonCardHeader title={FormControlSizings} subTitle={FormControlSizingData} headClass="pb-0" />
        <CardBody>
