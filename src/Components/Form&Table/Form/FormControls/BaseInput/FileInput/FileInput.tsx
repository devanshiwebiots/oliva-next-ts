...
import { FileInputs, LargeFileInputExample, SmallFileInputExample } from "@/Constant/constant";
import CommonFileInput from "./Common/CommonFileInput";
import { FileInputData, FileInputDataList } from "@/Data/Form&Table/Form/FormData";
...
const FileInput = () => {
  return (
    <Col md="6">
      <Card>
        <CommonCardHeader title={FileInputs} subTitle={FileInputData} headClass="pb-0" />
        <CardBody>
