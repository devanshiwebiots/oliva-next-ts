'use client'
import { DefaultInputMask, FormControls, InputMasks } from "@/Constant/constant";
...
const InputMaskContainer = () => {
  return (
    <>
      <Breadcrumbs pageTitle={InputMasks} parent={FormControls} title={InputMasks} />
      <Container fluid>
        <Row>
          <Col xs="12">
            <Card>
              <CommonCardHeader title={InputMasks} subTitle={InputMaskData} headClass="pb-0" />
              <CardBody>
                <Row className="g-3">
                  <DateFormat />
                  <TimeFormat />
