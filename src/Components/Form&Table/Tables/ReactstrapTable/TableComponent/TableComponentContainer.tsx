...
import { AlertTitle, BadgesTable, CheckboxTitle, InputsTable, ProgressbarTitle, RadioButtonsTitle, ReactstrapTable, SelectTable, SwitchTable, TableComponents, TooltipTriggersTitle, UIComponentsTitle } from "@/Constant/constant";
...
const TableComponentContainer = () => {
  return(
  <>
    <Breadcrumbs pageTitle={TableComponents} parent={ReactstrapTable} title={TableComponents} />
    <Container fluid>
      <Row>
