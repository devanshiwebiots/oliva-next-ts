...
const StockResult = () => {
  ...
  const filteredItems = StockResultData.filter((item) => Object.values(item).some((value) => value && typeof value === "string" && value.toLowerCase().includes(filterText.toLowerCase())));
