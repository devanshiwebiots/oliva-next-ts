...
import { AddContacts, Cancel, Email, FirstName, LastName, Mobile, Name, NewContacts, Phone, Save } from "@/Constant/constant";
...
const CreateContact = () => {
  ...
  return (
    <>
      <Button block color="primary" className="btn-mail w-100" onClick={toggle}><Users className="me-2" />{NewContacts}</Button>
