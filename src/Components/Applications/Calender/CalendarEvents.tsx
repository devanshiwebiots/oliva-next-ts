...
import { CalendarFilter, DraggableEvents, Href, RemoveAfterDrop } from "@/Constant/constant";
import { CalenderInitialData } from "@/Data/Applications/Calendar/CalendarData";
  ...
  return (
    <Col xxl="3" className="box-col-4e">
      <div className="md-sidebar mb-3">
        ...
        <div id="external-events" className="calendar-default custom-Draggable">
