import { Add, AddLabel, Cancel } from "@/Constant/constant";
...
export default function AddLabelModal() {
  ...
  const { modal } = useAppSelector((state) => state.email);
      ...
      <ModalBody>
        <Form>
          <Row className="g-sm-3 g-2 custom-input">
            ...
            <Col sm="2" xs="2"><Input className="form-control-color" defaultValue="#008dab" type="color" title="Choose your color" /></Col>
          </Row>
        </Form>
      </ModalBody>
      <ModalFooter>
