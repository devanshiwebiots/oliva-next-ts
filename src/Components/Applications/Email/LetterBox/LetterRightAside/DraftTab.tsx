...
import { DraftEmailData } from "@/Data/Applications/Email/EmailData";
          ...
          <li className="inbox-data" key={i}>
            ...
            <div className="inbox-message">
              <div className="email-data" onClick={handleOpenValue}>
                ...
                {item.badge && item.badge.map((data, j) => (<Badge color="" className={`inbox-width badge-light-${data.color}`} key={j}>{data.title}</Badge>))}
              </div>
