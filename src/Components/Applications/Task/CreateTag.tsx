...
import { Cancel, CreateTags, Save, TagColor, TagName } from "@/Constant/constant";
        ...
        <Form className="form-bookmark needs-validation" onSubmit={handleSubmit(AddTag)}>
          <Row>
            ...
            <Col md="12" className="mt-0">
              ...
              <input className={`form-color d-block  ${validation && `${errors.color ? "is-invalid" : "is-valid"}`}`} type="color" {...register("color", { required: true })} defaultValue="#008dab" />
            </Col>
          </Row>
