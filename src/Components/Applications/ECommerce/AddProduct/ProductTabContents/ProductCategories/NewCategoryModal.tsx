import { Add, Cancel, CategoryName, CreateNewCategory } from '@/Constant/constant';
    ...
    return (
        <Col xs={12}>
            <div className="category-buton">
                <Button color='transparent' onClick={toggle}><i className="me-2 fa fa-plus" /> {CreateNewCategory} </Button>
            </div>
