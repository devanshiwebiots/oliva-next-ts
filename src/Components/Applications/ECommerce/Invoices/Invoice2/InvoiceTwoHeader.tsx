        ...
        <td>
            <Table style={{ width: "100%" }} borderless>
                <tbody>
                    <tr>
                        <td>
                            <Image className='for-light' width={120} height={36} src={`${ImagePath}/logo/logo-1.png`} alt="logo" unoptimized/>
                            <Image className='for-dark' width={120} height={36} src={`${ImagePath}/logo/logo.png`} alt="logo" unoptimized/>
                        ...
                        <td style={{ opacity: "0.8", textAlign: "end" }}>
                            <span style={{ display: "block", lineHeight: "1.5", fontSize: 18, fontWeight: 500 }}>
                                {'Email : Oliva@themesforest.com'}
                            </span>
                            <span style={{ display: "block", lineHeight: "1.5", fontSize: 18, fontWeight: 500 }}>
                                {'Website: www.Olivathemes.com'}
                            </span>
                            <span style={{ display: "block", lineHeight: "1.5", fontSize: 18, fontWeight: 500 }} >
