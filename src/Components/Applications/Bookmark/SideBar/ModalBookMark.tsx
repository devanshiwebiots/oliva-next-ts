...
import { AddBookmark, Cancel, Collection, Description, Group, Save, Title, WebUrl } from "@/Constant/constant";
...
const BookmarkModal = () => {
  ...
  return (
    <Modal isOpen={addModal} toggle={addToggle} size="lg" className="modal-bookmark">
