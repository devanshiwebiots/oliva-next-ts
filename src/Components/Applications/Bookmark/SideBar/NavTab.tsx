...
import { Href, NewBookmark, Tags, Views } from "@/Constant/constant";
...
import { BookmarkSideData, BookmarkTagData } from "@/Data/Applications/Bookmark/BookmarkData";
...
const NavTab = () => {
  ...
  return (
    <Nav className="main-menu" role="tablist">
      <li>
        <Button color="primary" className="btn-block btn-mail w-100" onClick={() => dispatch(setAddModal())}>
