    ...
    <Col xxl="4" lg="4" md="6">
      <div className={`project-box ${item.progress === 100 ? "b-light1-success" : "b-light1-primary"}`}>
        ...
        <div className="project-status mt-4">
          ...
          {item.progress === 100 ? <Progress className='sm-progress-bar' animated striped color='success' value={item.progress} /> : <Progress className='sm-progress-bar' animated striped color='primary' value={item.progress} />}
        </div>
      </div>
    </Col>
  );
