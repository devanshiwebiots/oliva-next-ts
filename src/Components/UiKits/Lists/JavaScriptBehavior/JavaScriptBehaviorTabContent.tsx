      ...
      <TabContent activeTab={basicTab} id="nav-tabContent">
        <TabPane tabId="1">
          ...
          <div className="d-xl-flex list-behavior-2">
            ...
            <div className="flex-shrink-0"><Image width={134} height={86} className="tab-img img-fluid" src={`${ImagePath}/blog/blog.jpg`} alt="home" /></div>
          </div>
        </TabPane>
        <TabPane tabId="2" className="dark-list">
          <div className="flex-space align-items-center list-light-dark contact-profile"><Image width={100} height={100} className="tab-img" src={`${ImagePath}/avtar/3.jpg`} alt="profile" />
