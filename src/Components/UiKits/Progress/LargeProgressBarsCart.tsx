...
import { LargeProgressBars } from "@/Constant/constant";
import { LargeProgressData, LargeProgressList } from "@/Data/Uikits/Progress/ProgressData";
  ...
  return (
    <Col xl="6">
      <Card className="height-equal">
        <CommonCardHeader title={LargeProgressBars} subTitle={LargeProgressData} headClass="pb-0" />
