...
import { Description, Href, MaterialStyleTab, Review, User } from "@/Constant/constant";
import { MaterialStyleData } from "@/Data/Uikits/Tabs/TabsData";
...
const MaterialStyleTabs = () => {
  ...
  return (
    <Col xxl="6">
      <Card>
        <CommonCardHeader title={MaterialStyleTab} subTitle={MaterialStyleData} headClass="pb-0" />
        <CardBody>
