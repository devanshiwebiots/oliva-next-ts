...
import { BadgeHeadingsExample } from "@/Constant/constant";
import { BadgeExData } from "@/Data/Uikits/TagAndPills/TagAndPillsData";
  ...
  return (
    <Col sm="12" xl="6">
      <Card className="height-equal">
        <CommonCardHeader title={BadgeHeadingsExample} subTitle={BadgeExData} headClass="pb-0" />
        <CardBody>
