...
import { Href, ImagePath, PortfolioTitle } from "@/Constant/constant";
import { MasonryImageData } from "@/Data/Miscellaneous/Gallery/GalleryData";
                ...
                <Item original={`${ImagePath}/${element.src}`} width="700" height="750" caption={description}>
                  {({ ref, open }) => (
                    <Link href={Href} onClick={open}>
                      <img className="img-thumbnail rounded-0 rounded-top-1" ref={ref} src={`${ImagePath}/${element.src}`} alt="images" />
