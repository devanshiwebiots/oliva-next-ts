...
import { DeleteRowDataProp, FilteringTableNameProp } from "@/Types/TableType";
...
export const FilteringTableColumn = [
  {
    name: "Employee Name",
    selector: (row: DeleteRowDataProp) => `${row.name}`,
    cell: (row: DeleteRowDataProp) => <FilteringTableNameData image={row.image} name={row.name} />,
