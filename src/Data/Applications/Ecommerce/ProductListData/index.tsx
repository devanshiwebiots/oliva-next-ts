...
export const productListTableData: ProductListType[] = [
    {
        imageSrc: 'product_list/product-categories/laptop.png',
    ...
    {
        imageSrc: 'product_list/product-categories/phone.png',
    ...
    {
        imageSrc: 'product_list/product-categories/headphone.png',
    ...
    {
        imageSrc: 'product_list/product-categories/wireless-headphone.png',
    ...
    {
        imageSrc: 'product_list/product-categories/1.png',
    ...
    {
        imageSrc: 'product_list/product-categories/ipad.png',
    ...
    {
        imageSrc: 'product_list/product-categories/mouse.png',
    ...
    {
        imageSrc: 'product_list/product-categories/watch.png',
    ...
    {
        imageSrc: 'product_list/product-categories/dvd.png',
        productName: 'DVD',
        sku: 'HG5667DFQ1',
        category: 'Electric',
        price: '5600.00',
    ...
    {
        imageSrc: 'product_list/product-categories/speaker.png',
...
export const productListColumns: TableColumn<ProductListType>[] = [
        ...
        cell: (row) => (
            <div className="product-names">
                <div className="light-product-box">
                    <RatioImage className="img-fluid" src={`${ImagePath}/${row.imageSrc}`} alt="" />
                </div>
                <p>{row.productName}</p>
            </div>
        ),
    ...
    },
    {
        ...
        sortable: true,
        cell: (row) => (
            <Badge color={`${row.status === 'Sold Out' ? 'secondary' : 'primary'}`}>{row.status}</Badge>
        ),
    },
    {
        name: 'Rating',
    ...
    },
    {
        ...
        cell: (row) => (
            <div className="product-action">
                <Link href={`${process.env.PUBLIC_URL}/app/ecommerce/add-products`}>
