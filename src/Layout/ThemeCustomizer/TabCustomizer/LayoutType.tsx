...
const LayoutType = () => {
  const localStorageLayout = ConfigDB.settings.layout_type;
  ...
  const handleLayout = (layout: string) => {
    ...
    if (layout === "rtl") {
        ...
        ConfigDB.settings.layout_type = "rtl"
    } else if (layout === "ltr") {
        document.body.classList.add("ltr");
        document.body.classList.remove("rtl");
        document.body.classList.remove("box-layout");
        document.documentElement.dir = "ltr";
        ConfigDB.settings.layout_type = "ltr"
        ...
        document.documentElement.dir = "ltr";
        ConfigDB.settings.layout_type = "box-layout";
    }
  };
